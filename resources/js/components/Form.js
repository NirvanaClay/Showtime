...
const Form = ({ user, Link, results, getResults, fetchResults, streamingServices, checkStreaming, sliderPosition, setSliderPosition, showType, streamingId, noStreaming, series, getSeries, movies, getMovies }) => {
