...
const MoviesList = ({ movies, getMovies, Link, sliderPosition, setSliderPosition, checkStreaming, streamingId, streamingServices, showRatings, setShowRatings, loginStatus, user, noStreaming, spinnerDegree, setSpinnerDegree }) => {
